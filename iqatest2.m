...
Metric=[2];%1,PSNR;2,SSIM;3,MSSIM;4,VIF;5,VSNR;6,MAD;7,IW-SSIM;8,FSIM;9,GMSD;   20,BIQI;21,BRISQUE;22,DIVINE;23,BLIINDS;24,QAC;
for m=1:length(DataBase)
    for n=1:length(Metric)
        ...
        [CC,SROCC,RMSE]=performance_eval(iqa_sub,iqa_obj,0);
        %m,n,
   end
end
end
...
txtpath=strcat(txtpath,MetricNum);
